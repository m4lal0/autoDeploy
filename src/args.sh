...
function helpPanel(){
    ...
    echo -e "\t${turquoiseColour}[${redColour}-h${turquoiseColour}]${purpleColour} Mostrar este panel de ayuda${endColour}"
    echo -e "\t${turquoiseColour}[${redColour}-d${turquoiseColour}]${purpleColour} Eliminar directorios de los aplicativos creados${endColour}"
