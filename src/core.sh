...
LINUX_PATH="$UTILITIES_PATH/Linux"
WINDOWS_PATH="$UTILITIES_PATH/Windows"
PIVOTING_PATH="$GIT_TOOLS_PATH/Pivoting"
PHISHING_PATH="$GIT_TOOLS_PATH/Phishing"
WEB_PATH="$GIT_TOOLS_PATH/Web"
WIFI_PATH="$GIT_TOOLS_PATH/Wifi"
WORDPRESS_PATH="$WEB_PATH/Wordpress"
AD_PATH="$GIT_TOOLS_PATH/AD"
MOBILE_PATH="$GIT_TOOLS_PATH/Mobile"
CLOUD_PATH="$GIT_TOOLS_PATH/Cloud"
IA_PATH="$GIT_TOOLS_PATH/IA"
